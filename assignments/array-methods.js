...
firstNamesAllCaps = runners.map(first_name => {
  return first_name.first_name.toUpperCase();
});
...
// example: 
// let newTicket = [];
// newTicket = ticketArray.reduce((total, ticketArray) =>{ 
//   return total + ticketArray.price;
// }, 0)
